 ...
 */
final class Version20240217121246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_pack ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation_pack ADD CONSTRAINT FK_81E7934BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_81E7934BA76ED395 ON reservation_pack (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_pack DROP FOREIGN KEY FK_81E7934BA76ED395');
        $this->addSql('DROP INDEX IDX_81E7934BA76ED395 ON reservation_pack');
        $this->addSql('ALTER TABLE reservation_pack DROP user_id');
